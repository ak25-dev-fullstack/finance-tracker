export const Colors = {
  light: { text: '#F8FAFC', background: '#0F172A', tint: '#1E86C3', icon: '#94A3B8', tabIconDefault: '#64748B', tabIconSelected: '#1E86C3' },
  dark: { text: '#F8FAFC', background: '#0F172A', tint: '#1E86C3', icon: '#94A3B8', tabIconDefault: '#64748B', tabIconSelected: '#1E86C3' },
};
...
export const C = {
  ...
  brand: '#1E86C3',
  brandLight: '#1E86C3',
  brandBg: 'rgba(30,134,195,0.15)',
  brandBorder: 'rgba(30,134,195,0.3)',
  income: '#22C55E',
  ...
  expenseText: '#F8FAFC',
  balance: '#1E86C3',
  balanceBg: 'rgba(30,134,195,0.12)',
  balanceBorder: 'rgba(30,134,195,0.3)',
  warning: '#F59E0B',
